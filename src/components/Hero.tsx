        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight">
              Test x402 Payment Flows on{" "}
              <span className="text-brand">Solana</span>
            </h1>

            <p className="text-xl text-gray-300 leading-relaxed">
              Build, test, and validate micropayment-protected APIs using USDC.
              Perfect for AI agents and premium APIs.
            </p>
            ...
            <div className="flex gap-8 pt-4">
              ...
              <div>
                <div className="text-3xl font-bold text-brand">Fast</div>
                <div className="text-sm text-gray-400">Testing Experience</div>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div
              ...
              style={{
                background:
                  "linear-gradient(to bottom right, #5e17eb, #009950)",
              }}
            >
              <div className="bg-gray-200 rounded-lg p-6 font-mono text-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="text-gray-400 mt-2">
                    $ <span className="text-purple-600">x402test init</span>
                  </div>
                  <div className="text-green-600">✓ Test wallet created</div>
                  <div className="text-green-600">✓ Config file generated</div>
                  <div className="text-gray-400 mt-2">
                    $ <span className="text-purple-600">x402test start</span>
                  </div>
                  <div className="text-green-600">✓ Server ready at :4402</div>
